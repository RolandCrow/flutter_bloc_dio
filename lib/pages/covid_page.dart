...
import 'package:flutter_bloc_dio/blocs/covid_bloc/covid_bloc.dart';
import 'package:flutter_bloc_dio/models/covid_model.dart';

class CovidPage extends StatefulWidget {
  
  @override
  State<StatefulWidget> createState() => _CovidPageState();
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('Total Death: ${model.countries![index].totalDeath}'),
                    Text(
